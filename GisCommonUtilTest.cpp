...
int main(int argc, char* argv[])
{
	...
	cout << "==============" <<endl;
	LonLat A(jd1,wd1),B(jd2,wd2);
	double distance = CLonLatHelper::distance(jd1,wd1,jd2,wd2, &angle);
	//cout << CLonLatHelper::distance(A,B, &angle) << endl;
	cout << distance << endl;
	cout << "angle: " << angle <<endl; 
	cout << "==============" <<endl;
	LonLat C = CLonLatHelper::GetLonLatB(A, distance, angle);
